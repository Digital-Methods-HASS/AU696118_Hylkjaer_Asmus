...
---
This document is solely made for adding the timeslider which is done in line 
52. the rest of the creation process is documented in Creation_of_map.R
...
leaflet(shared_data, width = "100%", height = 800) %>% 
  ...
  addAwesomeMarkers(Heritage_list2$longitude, 
                    ...
                    popup = paste("Category:",Heritage_list2$category,"<br>",
